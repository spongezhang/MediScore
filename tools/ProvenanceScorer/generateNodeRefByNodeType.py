...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='MFC19_Image_ProvValidation_Ver1', help='Name of the dataset')
    parser.add_argument('--dataset_index', type=str, default='MFC19', help='Index of the dataset')
