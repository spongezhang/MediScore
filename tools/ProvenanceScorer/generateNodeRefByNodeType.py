...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='NC2017_EvalPart1_Ver1', help='Name of the dataset')
    parser.add_argument('--dataset_index', type=str, default='NC2017_EvalPart1', help='Index of the dataset')
