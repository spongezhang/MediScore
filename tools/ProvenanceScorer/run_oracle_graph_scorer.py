...
if __name__ == '__main__':
    ...
    parser.add_argument("--dbname", nargs='?', type=str, default = 'MFC18_EvalPart1_Ver1',
                        help="Database dataset name")

    parser.add_argument("--indexname", nargs='?', type=str, default = 'MFC19',
                        help="Database dataset name")
    ...
    system_output_dir = args.output_dir + 'output/' + args.dbname + '/submit/'

    output_directory = args.output_dir + 'score/{}/end-to-end/'.format(args.dbname)
    index_file = root_dir + 'indexes/' + index_name + '-provenance-oracle-index.csv'
